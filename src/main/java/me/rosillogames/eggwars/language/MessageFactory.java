...
import me.rosillogames.eggwars.utils.HexUtils;
...
public class MessageFactory {
    ...
    public static String[] factGetMessages(String msg, final boolean prefix, final Object... args) {
        ...
        final String[] msga = HexUtils.colorify(msg).split("\\n");

        if (prefix) {
            msga[0] = HexUtils.colorify("&7") + msga[0];
        }
        return msga;
    }
