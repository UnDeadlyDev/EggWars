...
public class Arena
{
    ...
    public void joinArena(EwPlayer player, boolean silently, boolean toSpectate)
    {
        ...
        {
            this.sendBroadcast("gameplay.lobby.player_joined", player.getPlayer().getDisplayName(), Integer.valueOf(this.players.size()), Integer.valueOf(this.getTeams().size() * this.maxTeamPlayers), ChatUtils.replace("%vault_rank%", player.getPlayer()), ChatUtils.replace("%alonsoplus_color%", player.getPlayer()), ChatUtils.replace("%alonsotags_tag_chat%", player.getPlayer()));
        }
    ...
    public void leaveArena(EwPlayer player, boolean sendBungee, boolean silent)
    {
        ...
        {
            this.sendBroadcast("gameplay." + (this.status.isLobby() ? "lobby" : "ingame") + ".player_left", player.getPlayer().getDisplayName(), Integer.valueOf(this.players.size()), Integer.valueOf(this.getTeams().size() * this.maxTeamPlayers), ChatUtils.replace("%vault_rank%", player.getPlayer()), ChatUtils.replace("%alonsoplus_color%", player.getPlayer()), ChatUtils.replace("%alonsotags_tag_chat%", player.getPlayer()));
        }
